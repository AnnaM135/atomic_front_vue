...
<template>
  <div>
    ...
    <div class="checkbox-container">
      ...
      <div class="checkbox-column">Checked: <Checkbox v-model="isChecked" class="checkbox--checked" /></div>
      <div class="checkbox-column">Interminate: <Checkbox v-model="isChecked" intermediate /></div>
